...
@interface ZhCountBtnSetting : NSObject
...
@protocol ZhCountBtnDeleget <NSObject>
@optional
...
@interface ZhCountBtn : UIButton

@property (nonatomic, strong)   id<ZhCountBtnDeleget> delegate;
